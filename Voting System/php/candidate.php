...
<head>
    ...
    <link rel="stylesheet" href="/stylesheets/candidate.css">
...
<body id="addcandidate">
    ...
    <div id="add" v-if="isClicked">
        <div class="addcontainer">
            <div class="imgbtn">
                <button id="insertbtn">Insert Image</button>
            </div>
            <p>Surname</p>
            <input type="text" class = "intext"id = "surtext">
            <p>First name</p>
            <input type="text" class = "intext" id = "firsttext">
            <p>Middle Name</p>
            <input type="text" class = "intext" id = "mntext">
            <p>Age</p>
            <input type="text" class = "intext" id = "agetext"><br><br>
            <input type="radio" name="gender" id="male">Male 
            <input type="radio" name="gender" id="female" style="margin-left: 30px;">Female
            <p>Student Number</p>
            <input type="text" class = "intext" id = "stnotext">
            <p>Course</p>
            <input type="text" class = "intext" id = "coursetext">
            ...
            <p>Partylist:</p>
            <input type="text" class = "intext" id = "plist">
        </div>
        <div class="btns">
